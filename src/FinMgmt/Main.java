...
import java.util.Scanner;
    ...
    public class Main {
        private static Accounts[] accountsList = new Accounts[100]; // Array to store accounts
        private static Transactions[] transactionsList = new Transactions[1000]; // Array to store transactions
        ...
        public static void createAccount() {
            ...
            accountsList[accountCount++] = account;
        ...
        public static void createTransaction() {
            ...
            if (account != null) {
                ...
                transactionsList[transactionCount++] = transaction;
        ...
        public static void displayAccounts() {
            ...
            for (int i = 0; i < accountCount; i++) {
                accountsList[i].displayAccountInfo();
            }
        }
        ...
        public static void displayTransactions() {
            ...
            for (int i = 0; i < transactionCount; i++) {
                transactionsList[i].displayTransactionInfo();
            }
        }
